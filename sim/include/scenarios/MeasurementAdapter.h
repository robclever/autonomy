...
// Converts sensor detections into SLAM measurements (algorithm input).
//
...
{
  public:
    // Convert detections to measurements with unknown association (no landmarkId).
    ...
    // Convert with ground-truth data association. For each detection, finds the
