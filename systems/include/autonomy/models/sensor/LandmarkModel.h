...
namespace systems::autonomy::models
{
    ...
    class LandmarkModel
    {
        public:
            ...
            // Add a feature to the map. This is used to update the map with new features that are observed by the sensor.
            virtual bool add_feature(const RadarEcho& feature);

            // Likelihood that a given measurement fits set, given the current state of the map. This is used to compute the likelihood of a measurement given the current state of the map.
        ...
        private:
            // Map that consists of a list of features, which are the measurements that are observed by the sensor.
